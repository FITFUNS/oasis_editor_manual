...
This is the main interface to the OasisW Editor. You can see labeled the main areas:
...
* [**Inspector**](inspector.md) Detailed properties of the selected Entity, Asset or Component.
