...
Splats can cast shadows onto meshes (see the GSplatComponent's [castShadows](https://manual.oasisserver.link/engine/classes/GSplatComponent.html#castshadows) property).
