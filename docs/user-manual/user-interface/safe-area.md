...
(Image Original: Rafael Fernandez, Modified version:OasisW, [CC BY-SA 4.0][cc-by-sa-40], via Wikimedia Commons)
...
We have a project with a reusable script that takes those CSS values and applies them to an UI Group Element entity via resizing the margins.
