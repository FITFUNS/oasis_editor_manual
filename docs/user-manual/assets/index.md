...
OasisW supports the importing of a wide variety of content types:
...
Put simply, Source Assets reference the original files that you uploaded. Target Assets are created at the end of the import pipeline for any files that have been generated by the OasisW conversion and optimization process.
