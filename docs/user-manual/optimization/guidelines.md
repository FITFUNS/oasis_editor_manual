...
Here are some tips and hints on how to achieve good performance in your OasisW app.
...
* Be careful when enabling 'Use Device Pixel Ratio' in your project settings. This will cause your OasisW app to utilize the native resolution of a device reducing pixelation but can result in many more pixels being filled, which can cause a significant drop in frame rate. This can be adjusted at runtime after assessing the user's device capabilities. Read more at [Adjusting Device Pixel Ratio][2].
