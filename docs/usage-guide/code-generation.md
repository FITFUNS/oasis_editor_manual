...
단축키 **Command + M** (macOS) 또는 **Alt + M** (Windows) 버튼을 눌러 모델 선택 창을 열고 닫을 수 있습니다.  
이곳에서 AI 모델을 변경할 수 있습니다.
...
3. **Undo All/Keep All 버튼**을 활용하여 코드를 업데이트합니다.

![Image](/img/usage-guide/13_9.png)

* **Undo All** : 생성된 코드가 아닌 기존 코드로 되돌립니다.
* **Keep All** : 히스토리에 저장하며 생성된 코드를 적용합니다.
