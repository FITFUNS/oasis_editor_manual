...
You must import `Entity` from `OasisW` for your attribute to parse correctly.
...
You must import `Asset` from `OasisW` for your attribute to parse correctly.
...
You must import `Color` from `OasisW` for your attribute to parse correctly.
...
You must import `Vec2`/`Vec3`/`Vec4` from `OasisW` for your attribute to parse correctly.
...
You must import `Curve` from `OasisW` for your attribute to parse correctly.
