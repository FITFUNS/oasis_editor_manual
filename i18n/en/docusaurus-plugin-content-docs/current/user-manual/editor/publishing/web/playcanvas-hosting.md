---
title: OasisW Hosting
---

The fastest, easiest, most convenient way to publish your game is to publish it to OasisW.com.

Publishing to OasisW consists of two simple steps:
...
* Click the PUBLISH button next to "Publish on OasisW".
...
* You will then have to fill out some details about your new build. The available fields are:
  ...
  * *Concatenate Scripts*: Check this to combine all of your OasisW scripts into a single JavaScript file.
  * *Minify Scripts*: Check this to minify your OasisW scripts to reduce the file size.
